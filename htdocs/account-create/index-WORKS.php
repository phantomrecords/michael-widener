...
function hc_secret_key_bytes(): string
{
    ...
    // Fallback: a locked file in site root (deny access via .htaccess)
...
$state = 'form'; // form | submitted
$error = '';
$ref = '';

if ($_SERVER['REQUEST_METHOD'] === 'POST') {

    // Save draft regardless
    $draft = [
...
<head>
  <meta charset="utf-8" />
  <title>Account Create — Michael Widener II</title>
  ...
  <div class="page">
    ...
    <section>
      ...
      <?php else: ?>
        ...
        <form class="box" method="post" action="/account-create/">
